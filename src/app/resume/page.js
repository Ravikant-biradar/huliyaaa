...
const Resume = () => {
  ...
  // Ensuring the component is mounted before rendering to avoid hydration issues
  useEffect(() => {
    setMounted(true);
  }, []);

  // Prevent rendering until client-side has fully loaded
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="mt-2 text-gray-300">
                ...
                optimized backend APIs, and enhanced UI/UX for better customer
                engagement.
              </p>
            </div>
            <div>
